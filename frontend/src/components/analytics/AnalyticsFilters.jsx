...
export const AnalyticsFilters = ({ filters, onFilterChange }) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (localRepoSearch !== filters.repository) {
        onFilterChange({ ...filters, repository: localRepoSearch });
      }
    }, 500);
  ...
  return (
    <div className="bg-card border border-border p-4 rounded-lg shadow-sm">
      <div className="flex flex-col lg:flex-row items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground font-medium shrink-0 lg:ml-auto">
